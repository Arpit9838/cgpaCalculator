...
public class welcome extends javax.swing.JFrame {
    ...
    private void initComponents() {
       ...
       jButton1.setBounds(470, 260, 146, 37);
        ...
        jLabel5.setFont(new java.awt.Font("Buxton Sketch", 0, 28)); // NOI18N
   ...
   // Check if name is empty
     ...
     if (index == -1 || index == 0) {
        JOptionPane.showMessageDialog(this, "Please select your department!", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    private void setIconImage() {
       setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("WhatsApp Image 2023-04-24 at 21.45.05.jpeg"))); 
    }
}
